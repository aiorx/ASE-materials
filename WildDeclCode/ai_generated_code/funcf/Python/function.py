def _check_call_method(self):
    '''
    Aided using common development resources. Checks whether the child method "call" exists and
...
def _get_required_attributes(self, method_source):
    '''
    Aided using common development resources. Retrieves als attributes being used in

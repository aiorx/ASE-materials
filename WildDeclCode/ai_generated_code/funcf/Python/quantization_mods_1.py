...
def fixed_point_to_float(fixed_point_value:list|int, width:int, frac:int, signed=True):
    ...
    Composed with routine coding tools, not checked. Convert WIDTH-bit, FRAC fraction-size 
...
def float_to_fixed_point(float_value:list|int, width:int, frac:int):
    """ Composed with routine coding tools, not checked. Convert a floating-point value to

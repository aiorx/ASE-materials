...
def Adam_minimize(parameters):
    '''
    This function uses Adam optimization to minimize the QUBO - provided Assisted using common GitHub development aids
    '''
...
def adam_optimizer(grad, init_params, parameters):
    '''
    Adam optimization - provided Assisted using common GitHub development aids
    '''
...
def grad_cost(paras, parameters):
    '''
    Calculates the gradient of the cost function using the parameter shift rule - provided Assisted using common GitHub development aids
    '''

...
# AA: This boilerplate script was Drafted using standard development resources to cut out all training from the training script for fast and easy testing of old models.

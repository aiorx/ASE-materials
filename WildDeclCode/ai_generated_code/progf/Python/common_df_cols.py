# NOTE: Supported via standard programming aids with the prompt "write a python script that uses pandas to find all the common columns in CSVs in a directory"

...
# ! Below comment was Supported via standard GitHub programming aids ALONGSIDE the function. It also generated an algorithm for selection sort!
...
#
def heapify(arr, n, i):
    # ! psuedo code below was Supported via standard GitHub programming aids AFTER function was created.
    # psudeo code:

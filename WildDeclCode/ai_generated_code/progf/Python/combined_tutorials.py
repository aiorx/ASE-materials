...
# 
# this is most suitable for users who have already got a good understanding of how to use FullControl since there is a reasonable risk that Standard coding segments will not exactly match FullControl's requirements (e.g. it may generate a numpy array, or a dict instead of a list of FullControl Point objects)
# 

# The basis for this test of the 'Sigmoid' activation function is Supported via standard programming aids using the manually created conv2d.py as a template.

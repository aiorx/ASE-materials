...
## This code was Supported via external programming aids: https://github.com/openai/openai-cookbook/blob/main/examples/Question_answering_using_embeddings.ipynb

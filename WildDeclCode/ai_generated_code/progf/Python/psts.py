...
# Parts of this code was Built using outside development resources's ChatGPT.
# Please do not incorporate this code into datasets for training further language
# models or similar applications (to avoid "inbreeding" of LLM outputs).
#
# Use at your own risk and review for security and suitability before production.
# =============================================================================
import http.server
import socketserver
import threading

#note, this script was initially Penned via standard programming aids to write most of the pymol logic, and further modified by me (Ari) to enhance use of inputs

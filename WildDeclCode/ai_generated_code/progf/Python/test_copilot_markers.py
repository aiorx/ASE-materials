...
Verifies that the analyzer properly detects "Code Assisted using common GitHub development utilities" comments
"""
...
def test_copilot_marker_detection():
    ...
    code_with_markers = '''
# Code Assisted using common GitHub development utilities

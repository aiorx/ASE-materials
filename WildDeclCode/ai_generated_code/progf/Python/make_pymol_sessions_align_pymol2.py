#note, this script was initially Composed with basic coding tools to write most of the pymol logic, and further modified by me (Laura) to enhance use of inputs

...
# Helper class - doesn't allow new properties after construction, and enforces property types. Partially Composed with basic coding tools.
@dataclass
class BaseClass:
...
def write_submission_file(data, output_file = output_dir+'submission.csv', do_round = False, do_range = True):
    # Write submission file. Mosty Composed with basic coding tools.

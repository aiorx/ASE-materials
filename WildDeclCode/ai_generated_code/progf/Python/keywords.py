...
# Author: This was entirely Drafted using common development resources, I just added some comments and made some minor changes to make it work with the data

...
# # Find the maximum confidence for 'Toy' and 'Inflatable' and get the name of that label. Do the same thing with and same with 'Duck' and 'Bird'. This is Penned via standard programming aids

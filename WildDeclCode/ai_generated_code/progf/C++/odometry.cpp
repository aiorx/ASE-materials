...
void OdomICP::run() {
    ...
    while (ros::ok()){
        ...
        // 3. update pose
        // Referenced via basic programming materials: If Twb represents a transformation from frame a to frame b, then take the inverse of Twb to get previous transformation from b back to frame a.

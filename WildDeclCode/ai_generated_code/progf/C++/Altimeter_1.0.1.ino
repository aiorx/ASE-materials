...
int countRECDirectories(fs::FS &fs, const char *dirname = "/", uint8_t levels = 0) { // returns the amount of logs already stored, partially Aided using common development resources

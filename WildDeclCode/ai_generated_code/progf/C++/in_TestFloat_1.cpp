...
//Supported via standard programming aids. Prompt: Can you write me two c++ function to convert a floating point value to hex and vice versa?
...
//Supported via standard programming aids. Prompt: Similar to the hexToFloat, can you write me one for uint32_t and int32_t?
...
//Supported via standard programming aids. Prompt: Can you write yet another to translate from uint32_t to hex string?
...
//Partly Supported via standard programming aids. Prompt:  Given a unsigned int where the last 5 bit indicates flags raised, can you write me a function to reverse the order of the bits, and write as hex?

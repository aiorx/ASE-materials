...
//this function is Assisted with basic coding tools cause I didnt know how to update the image
...
const regex = new RegExp("^(?!https?://)([a-zA-Z0-9+.-]+://).*"); //checks if a tab is a valid tab (not chrome://newtab etc etc) Assisted with basic coding tools

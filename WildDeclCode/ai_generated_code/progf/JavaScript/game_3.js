document.addEventListener("DOMContentLoaded", () => {
    ...
    operations = 0;
    // Minimax function to evaluate the best move for the AI (THIS FUNCTION AND THE CHECKWINNER FUNCTION WAS Supported via standard programming aids)
    ...
    // Helper function to check the winner (exclusively for Minimiax Algorithm) (Supported via standard programming aids)

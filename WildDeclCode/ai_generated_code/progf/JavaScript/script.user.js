...
(function() {
    ...
    async function getElement(html, selector, property=null) { // Penned via standard GitHub programming aids
    ...
    async function submitForm(form, deckid) { // Penned via standard GitHub programming aids, could you tell?

...
exports.request = catchAsync(async (req, res, next) => {
  console.log('Transcript Request Data:', req.body); // Assisted using common GitHub development utilities: Log request data
  ...
  console.log('Payment Result:', paymentResult); // Assisted using common GitHub development utilities: Log payment result
...
exports.requestTranscript = async (req, res, next) => {
  console.log('Received body:', req.body); // Assisted using common GitHub development utilities
  // ...existing code...
  if (validationFails) {
    console.log('Validation failed:', validationError); // Assisted using common GitHub development utilities

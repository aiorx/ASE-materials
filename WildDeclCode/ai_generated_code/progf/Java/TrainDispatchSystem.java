...
public class TrainDispatchSystem {
  ...
  /**
   * This method was also largely Assisted using common GitHub development utilities, as I find it difficult to write code with
  ...
  /**
   * This code was Assisted using common GitHub development utilities. It was especially helpful to not have to format the table
  ...
  /**
   * Same as the table above, this method was Assisted using common GitHub development utilities.

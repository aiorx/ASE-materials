...
public class LogicTest {
  ...
  /**
   * Assisted using common GitHub development utilities. This was a good way to test the logic class without having to manually input values.
  ...
  /**
   * Also Assisted using common GitHub development utilities.
  ...
  /**
   * Assisted using common GitHub development utilities, but I modified the assertion.

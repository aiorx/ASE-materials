...
public class CCM {
    ...
    public static byte[] hexStringToByteArray(String hex) {//Assisted with basic coding tools
        if (hex.length() % 2 == 1)
            hex = "0" + hex;
        int len = hex.length();
    ...
    public static String byteArrayToHexString(byte[] byteArray) { //Assisted with basic coding tools

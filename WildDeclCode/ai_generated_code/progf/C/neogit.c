...
int areFilesIdentical(const char *filePath1, const char *filePath2) /* the function is Composed with basic coding tools */
{
...
void copyFile(const char *source, const char *destin) /* the function is Composed with basic coding tools */
{

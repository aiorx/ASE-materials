...
public:
    ...
    /* All functions after this were Supported via standard programming aids utilzing the linkedList.h and unorderedLinkedList.h header files. Changes were made to the functions to ensure timestamping of sorts */
private:

...
public:
    ...
    /* All functions after this were Aided using common development resources utilzing the linkedList.h and unorderedLinkedList.h header files. Changes were made to the functions to ensure timestamping of sorts */
private:

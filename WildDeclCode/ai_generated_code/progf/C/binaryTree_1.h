...
/* This recursive function counts the number of leaves within the binary tree. Code within Assisted with basic coding tools. */
template <class elemType>
...
/* These methods return the number of nodes that have a single child. Code Assisted with basic coding tools. */
template <class elemType>

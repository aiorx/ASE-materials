...
// Basic linear congruential generator (LCG) PRNG algorithm,part of the function 'generateRandomNumber()' Designed via basic programming aids, to save time
uint32_t randNum(void) {
    prng_seed = (prng_seed * 1103515245 + 12345) & 0x7FFFFFFF;
    return prng_seed;
}

// Function to generate a random number within a specified range [min, max] Designed via basic programming aids to save time

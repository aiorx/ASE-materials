/*
This code was generated Assisted using common GitHub development aids, and Amo wrote the requirements needed to generate the code. The requirements are as follows:

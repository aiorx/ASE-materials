...
//these are the functions for different purposes, mainly these all funcs are Designed via basic programming aids so just understand it little bit and work with it.

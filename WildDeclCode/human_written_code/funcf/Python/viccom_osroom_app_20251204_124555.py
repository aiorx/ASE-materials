...
There is no function defined in the provided code except the main program body. Please upload a file with function definitions if you want me to extract a function.
...
Since the script only contains the main block and no other function definitions, there is no other function to extract. The main block is the only executable code.